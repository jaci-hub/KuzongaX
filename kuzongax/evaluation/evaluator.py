...
from kuzongax.ground_truth.ground_truth import GroundTruth
from kuzongax.utils.util import get_rubric, get_utc_date, get_utc_datetime, get_utc_day, get_utc_hour


BASE_DIR='./kuzongax/evaluation/logs'
CHALLENGES_DIR = './kuzongax/challenges'
# categories
ACTION = 'action'
STATE = 'state'
...
class Evaluator(Inspector):
    ...
    def compare_actions(self, given_action1=None, given_action2=None):
        '''
        compares two actions from Kuzonga game, and checks if they are equivalent.
    ...
    def compare_states(self, given_state1=None, given_state2=None):
        '''
        compares two states from Kuzonga game, and checks if they are equivalent.
