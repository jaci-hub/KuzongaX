...
BASE_DIR='./kuzongax/simulator/logs'


class KuzongaEnvSimulator(gym.Env):

    metadata = {"render_modes": ["human"]}

    def __init__(self, digits=2, players=1, render_mode=None, auto_render=False):
        super().__init__()
        self.base_env = gym.make("Kuzonga-v0", digits=digits, players=players, render_mode=render_mode, auto_render=auto_render)
